...
export const themeSummaries: Record<Theme, string> = {
  ...
  원전: "오늘 원전 테마는 해외 수주 기대감과 SMR 투자 이슈가 중심입니다.",
  배터리: "오늘 배터리 테마는 전기차 수요 회복과 차세대 배터리 기술이 부각되고 있습니다.",
  건설: "오늘 건설 테마는 부동산 PF 우려 완화와 주요 재건축 수주 소식이 핵심입니다.",
  부동산: "오늘 부동산은 전세가 및 매매가 추이와 정부의 대출 규제 정책이 주목받고 있습니다.",
  우주항공: "오늘 우주항공 테마는 스페이스X 관련 소식과 누리호 발사 준비가 주목받고 있습니다.",
  전쟁: "오늘 전쟁 테마는 중동 분쟁과 러시아-우크라이나 관련 소식이 중심입니다.",
};
